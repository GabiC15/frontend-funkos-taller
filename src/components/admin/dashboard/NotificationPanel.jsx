            ...
            <div className="flex flex-wrap items-center px-4 py-2">
              <div className="border-b-2 border-neutral-500 flex w-full">
                ...
                <div className="relative w-full py-2 max-w-full flex-grow flex-1 text-right">
                  <button
                    className="bg-blue-500 dark:bg-gray-100 hover:bg-gray-300 text-white active:bg-blue-600 dark:text-gray-800 dark:active:text-gray-700 text-xs font-bold uppercase px-3 py-1 rounded outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150"
                    type="button"
                  >
                    Limpiar todo
                  </button>

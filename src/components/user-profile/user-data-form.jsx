...
export default function UserDataForm() {
  ...
  const [updateUserData, { loading: loadingUpdate }] = useMutation(
    UPDATE_USUARIO,
    { refetchQueries: [GET_USUARIO] }
  );
            ...
            <form id="dataForm" onSubmit={handleSubmit}>
              <div className="flex flex-col w-full md:w-[30rem]">
                ...
                <button
                  id="updateBtn"
                  type="submit"
                  className="flex items-center justify-center bg-chineseBlack my-6 h-10 w-full rounded-xl"
